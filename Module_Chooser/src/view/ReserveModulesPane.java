...
public class ReserveModulesPane extends VBox {
    public ReserveModulesPane() {
        ...
        Button btn_RMVTerm1 = new Button("Remove");
        Button btn_RMVTerm2 = new Button("Remove");
        Button btn_CONFTerm1 = new Button("Confirm");
        Button btn_CONFTerm2 = new Button("Confirm");
        ...
        //List view
        ListView<String> txtfld_UnselecTerm1 = new ListView<>();
        ObservableList<String> options1 = FXCollections.observableArrayList();
        txtfld_UnselecTerm1.setPrefSize(10000,10000);
        txtfld_UnselecTerm1.setItems(options1);
        ListView<String> txtfld_UnselecTerm2 = new ListView<>();
        ObservableList<String> options2 = FXCollections.observableArrayList();
        txtfld_UnselecTerm2.setItems(options2);
        txtfld_UnselecTerm2.setPrefSize(10000,10000);

        ListView<String> txtfld_ReservTerm1 = new ListView<>();
        ObservableList<String> options3 = FXCollections.observableArrayList();
        txtfld_ReservTerm1.setItems(options3);
        txtfld_ReservTerm1.setPrefSize(10000,10000);

        ListView<String> txtfld_ReservTerm2 = new ListView<>();
        ObservableList<String> options4 = FXCollections.observableArrayList();
        txtfld_ReservTerm2.setItems(options4);
